...
app_description = "A system to manage gym memberships, trainers, workout plans, and classes"
app_email = "aithalrachana633@gmail.com"
app_license = "mit"
...
scheduler_events = {
    "daily": [
        "gym_management.gym_management_system.doctype.gym_membership.gym_membership.expire_memberships"
    ]
}
doctype_js = {
...
doc_events = {
    "Gym Locker Booking": {
        "validate": "gym_management.overrides.locker.validate_locker_booking"
    }
}
...
scheduler_events = {
    "cron": {
        "0 0 * * 0": [
            "gym_management.scheduler.weekly_class_summary"
        ]
    }
}
scheduler_events = {
    "weekly": [
        "gym_management.tasks.weekly_summary"
    ]
}

app_include_js = "/assets/gym_management/js/trainer_alert.js"
# doctype_js = {
#     "Gym Trainer Subscription": "public/js/trainer_alert.js"
# }